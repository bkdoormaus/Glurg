	...
	extract_compressed_2d: (call) =>
		...
		compression = switch format.value_name
			when "GL_COMPRESSED_RGB_S3TC_DXT1_EXT", "GL_COMPRESSED_SRGB_S3TC_DXT1_EXT"
				'bc1'
			when "GL_COMPRESSED_RGB_S3TC_DXT3_EXT", "GL_COMPRESSED_SRGB_S3TC_DXT3_EXT", "GL_COMPRESSED_RGBA_S3TC_DXT3_EXT"
				'bc2'
			when "GL_COMPRESSED_RGB_ALPHA_S3TC_DXT5_EXT", "GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT", "GL_COMPRESSED_RGBA_S3TC_DXT5_EXT"
				'bc3'
			else
